...
namespace crispritz
{
    ...
    class TernarySearchTree
    {
      public:
        ...
        TernarySearchTree(std::string_view sequence, std::string_view chr_name,
                          ...
                          bool pam_at_start, std::string_view outdir, int max_bulges = 0,
                          int num_threads = 1);
     ...
     * @p outdir.
     *
     * @param sequence    Full genomic sequence string (single chromosome, uppercase).
    ...
    void build_tree(const std::string& sequence, const std::string& chr_name,
                    ...
                    const std::string& outdir, int max_bulges = 0, int num_threads = 1);
