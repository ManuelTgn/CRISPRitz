...
inline bool check_pam_match(
    const uint8_t* genome_data,
    const uint8_t* pam_data,
    size_t pos,
    int pam_limit,
    int max_mismatches
) {
...
std::vector<int> search_pam_sites(
    ...
    const int max_mm = params.max_mismatches;
    const int max_bulges = params.max_bulges;
